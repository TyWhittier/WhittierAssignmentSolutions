...
%
% Answer: clear all clears all objects in the MATLAB® workspace 
%
...
%
% Answer: For loops: For loops will loop a specific number of times and
% keep track of each iteration
% While loops: While loops will loop as long as a condition remains true.
...
%
% Answer: NaN = Not a Number.  This happens when an equation is arithmetically
% indeterminate.  Trying to get an analysis of variance for one single
% number would produce NaN
anova1(1)
...
% Answer: 
% why
% To satisfy some young smart and tall and young not excessively smart programmer.
% why
% A rich system manager threatened the engineer.
% why
% A kid knew it was a good idea.
% why
% The customer is always right.
% why
% Damian obeyed some programmer.
% why
